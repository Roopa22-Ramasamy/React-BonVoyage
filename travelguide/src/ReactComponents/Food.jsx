    ...
    return (
      ...
      <Typography><h1 align="center" style={{color:'whitesmoke'}}>FOOD</h1></Typography>
        <Grid align="center" padding={"50px"} marginBottom="100px">
          <Paper variant='outlined' style={{width:'1200px',height:'695px', borderRadius:'20px' ,opacity:'0.8',paddingTop:"1px"}}>
          <Typography><h4 align="center">SELECT YOUR CUISINE</h4></Typography>
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                /> 
                 <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Food1">
                  <Button variant="contained" size="large" color='secondary'>SOUTH INDIAN</Button>
                  </Link>
                  </Typography>
              </div>  
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Food1">
                  <Button variant="contained" size="large" color='secondary'>NORTH INDIAN</Button>
                  </Link>
                  </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Food1">
                  <Button variant="contained" size="large" color='secondary'>PUNJABI</Button>
                  </Link>
                  </Typography>
              </div>
            </div>
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Food1">
                  <Button variant="contained" size="large" color='secondary'>BENGALI</Button>
                  </Link>
                  </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Food1">
                  <Button variant="contained" size="large" color='secondary'>KERALA</Button>
                  </Link>
                  </Typography>
              </div>
            </div>
