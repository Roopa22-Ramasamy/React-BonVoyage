            ...
            <Paper variant='outlined' style={{width:'1200px',height:'660px', borderRadius:'20px' ,opacity:'0.85'}}>
              <div style={{display: 'flex',flexWrap: 'wrap',padding: '0px 4px'}}>
                <div style={this.divstyle}>
                  ...
                  <Link to="../Accomodation1">
                  <Button variant="contained" size="large" color='secondary'>CAMPER VAN STAY</Button>
                  </Link>
                  </Typography>
                </div>
                <div style={this.divstyle}>
                  ...
                  <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Accomodation1">
                  <Button variant="contained" size="large" color='secondary'>RESORT STAY</Button>
                  </Link>
                  </Typography>
                </div>
                <div style={this.divstyle}>
                  ...
                  <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Accomodation1">
                  <Button variant="contained" size="large" color='secondary'>BOAT HOUSE STAY</Button>
                  </Link>
                  </Typography>
                </div>
              </div>
              <div style={{display: 'flex',
                ...
                <div style={this.divstyle}>
                  ...
                  <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Accomodation1">
                  <Button variant="contained" size="large" color='secondary'>COTTAGE STAY</Button>
                  </Link>
                  </Typography>
                </div>
                <div style={this.divstyle}>
                  ...
                  <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Accomodation1">
                  <Button variant="contained" size="large" color='secondary'>HOTEL STAY</Button>
                  </Link>
                  </Typography>
                </div>
              </div>
