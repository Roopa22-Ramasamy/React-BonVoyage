          ...
          <Paper variant='outlined' style={{width:'1200px',height:'710px', borderRadius:'20px' ,opacity:'0.8'}}>
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Transport1">
                  <Button variant="contained" size="large" color='primary'>CAR</Button>
                  </Link>
                  </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Transport1">
                  <Button variant="contained" size="large" color='primary'>BIKE</Button>
                  </Link>
                  </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Transport1">
                  <Button variant="contained" size="large" color='primary'>TRAIN</Button>
                  </Link>
                  </Typography>
              </div>
            </div>
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Transport1">
                  <Button variant="contained" size="large" color='primary'>FLIGHT</Button>
                  </Link>
                  </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Transport1">
                  <Button variant="contained" size="large" color='primary'>BUS</Button>
                  </Link>
                  </Typography>
              </div>
            </div>
