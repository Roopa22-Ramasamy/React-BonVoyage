          ...
          <Paper variant='outlined' style={{width:'1200px',height:'660px', borderRadius:'20px' ,opacity:'0.7'}}>
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Button variant='contained' color='secondary'>ACCOMODATION</Button>
               </Link>
                </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                  <Link to="../Basicneeds">
                    <Button variant="contained" size="large" color='secondary'>BASIC NEEDS</Button>
                  </Link>
                </Typography>
              </div>
            </div>
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Link to="../Entertainment">
                    <Button variant="contained" size="large" color='secondary'>ENTERTAINMENT</Button>
                  </Link>
                </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}>
                <Link to="../Transport">
                    <Button variant="contained" size="large" color='secondary'>TRANSPORT</Button>
                  </Link>
                </Typography>
              </div>
            </div>
