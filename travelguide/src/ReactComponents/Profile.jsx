...
export default class Profile extends Component {
    ...
    buttonstyle1={color:'F5F3E1',backgroundColor:'#FF007F',borderColor:'#0480AB',marginLeft:'90px', marginTop:'2px',marginBottom:'20px',padding:'5px',align:'center'}
    buttonstyle={color:'#F5F3E1',backgroundColor:'#FF007F',borderColor:'#0480AB',marginLeft:'130px', marginTop:'2px',marginBottom:'20px',padding:'5px',align:'center'}
    buttonstyle2={color:'#F5F3E1',backgroundColor:'#FF007F',borderColor:'#0480AB',marginLeft:'80px', marginTop:'30px',marginBottom:'20px',padding:'5px',align:'center',fontSize:'20px'}
    buttonstyle3={color:'#F5F3E1',backgroundColor:'#8EEBEC',borderColor:'#0480AB',marginLeft:'80px', marginTop:'30px',marginBottom:'20px',padding:'5px',align:'center',fontSize:'20px'}
    buttonstyle4={color:'#F5F3E1',backgroundColor:'#8EEBEC',borderColor:'#0480AB',marginLeft:'80px', marginTop:'30px',marginBottom:'20px',padding:'5px',align:'center',fontSize:'20px'}
        ...
        <Grid style ={{padding:'50px'}}>
                <Typography>
                    ...
                    <div style={{textAlign:'right'}}>
                        <Link to = '../Likedtrips'>
                        <Button variant='outlined'sx={{color:'#CA226B',backgroundColor:'#155AC6',borderColor:'#0480AB '}} startIcon = { < Avatar src = {'../heart.png'} /> } >
                           LIKED TRIPS
                        </Button></Link>
                    </div>
                            ...
                            <div style={{align:'center',display:'inline-block'}}>
                                ...
                                <div>
                                    <Box
                                        ...
                                        <br/>
                                        <Link to='../Choice'>
                                        <Button variant="contained" sx={this.buttonstyle1}>DARJEELING</Button>
                                        </Link>
                                ...
                                <div>
                                    <Box
                                        ...
                                        <br/>
                                        <Link to='../Choice'>
                                        <Button variant="contained" sx={this.buttonstyle}>JAIPUR</Button>
                                        </Link> 
                                </div>
                                <div>
                                    <Box
                                        ...
                                        <br/>
                                        <Link to='../Choice'>
                                        <Button variant="contained" sx={this.buttonstyle}>ANDAMAAN</Button>
                                        </Link> 
                                </div>
                                <div>
                                    <Box
                                        ...
                                        <br/>
                                        <Link to='../Choice'>
                                        <Button variant="contained" sx={this.buttonstyle}>VAARANASI</Button>
                                        </Link> 
                                </div>
                                <div>
                                    <Box
                                        ...
                                        <br/>
                                        <Link to='../Choice'>
                                        <Button variant="contained" sx={this.buttonstyle}>KOLKATA</Button>
                                        </Link>
                    ...
                    {/* <h2 style={{color:'#FCFAE9',align:'right'}}>PLAN A TRIP</h2> */}
                    <Link to='../Enjoy'>
                    <Button variant="variant" sx={this.buttonstyle3}>PLAN A TRIP</Button>
                     </Link>  
                ...
                <Link to="/">
                    <Button variant="contained" size="large" sx={this.buttonstyle}>BACK</Button>
                  </Link>
                </Typography>
            {/* </Paper> */}
        </Grid>
